                    ...
                    <div className="row ">
                        ...
                        <div className="col-lg-2 col-md-6 col-sm-12 foot-links-col">
                            ...
                            <ul className="foot-links">
                                ...
                                <li><a href="">Altin tahminleri</a></li>
                                <li><a href="">Çeyrek altin fiyati</a></li>
                                <li><a href="">Gram altin ne kadar?</a></li>
                                <li><a href="">Dolar ne kadar?</a></li>
                                <li><a href="">Mazot, benzin fiyati</a></li>
                                <li><a href="">Euro kaç lira?</a></li>
